...
PRE_UNINSTALL = :
POST_UNINSTALL = :
ACLOCAL = ${SHELL} /tmp/syntorxgen/missing --run aclocal-1.7
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /tmp/syntorxgen/missing --run tar
AUTOCONF = ${SHELL} /tmp/syntorxgen/missing --run autoconf
AUTOHEADER = ${SHELL} /tmp/syntorxgen/missing --run autoheader
AUTOMAKE = ${SHELL} /tmp/syntorxgen/missing --run automake-1.7
AWK = gawk
CC = gcc
...
LIBS = -lm 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /tmp/syntorxgen/missing --run makeinfo
OBJEXT = o
PACKAGE = syntorxgen
...
infodir = ${prefix}/info
install_sh = /tmp/syntorxgen/install-sh
